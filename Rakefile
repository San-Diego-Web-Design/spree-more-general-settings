...
desc 'Generate documentation for the more_general_settings extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'MoreGeneralSettingsExtension'
...
desc 'Test the more_general_settings extension.'
...
namespace :test do
  desc 'Functional test the more_general_settings extension.'
  ...
  desc 'Unit test the more_general_settings extension.'
